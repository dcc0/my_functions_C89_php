;Сложение двух трёхзначных аргументов командной строки и преобразование строки в число
;Взят здесь: https://asmtutor.com/#lesson16 (Спасибо участникам wasm.in за подсказку)
...
lp4:
    ...
    mul     ebx             ;Само умножение
     inc     ecx            ;Инкремент
     cmp ecx, 7             ;Условие выхода
jne lp4
                            ;Делим eax на 10 в конце, чтобы удалить лишний разряд
    mov     ebx, 10         ;move decimal value 10 into ebx
    div     ebx

add eax, edi ;Сложение двух аргументов
